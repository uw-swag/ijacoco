...
public abstract class AbstractAgentMojo extends AbstractJacocoMojo {
	 ...
	 */
	static final String AGENT_ARTIFACT_NAME = "org.bjacoco:org.bjacoco.agent";
	/**
	 ...
	 */
	@Parameter(property = "bjacoco.propertyName")
	String propertyName;
	/**
	 ...
	 */
	@Parameter(property = "bjacoco.append")
	Boolean append;
	 ...
	 * classes.
	 */
	@Parameter(property = "bjacoco.exclClassLoaders")
	 ...
	 * </ul>
	 */
	@Parameter(property = "bjacoco.output")
	String output;
	/**
	 ...
	 */
	@Parameter(property = "bjacoco.address")
	String address;
	/**
	 ...
	 */
	@Parameter(property = "bjacoco.port")
	Integer port;
	/**
	 ...
	 */
	@Parameter(property = "bjacoco.classDumpDir")
	File classDumpDir;
	/**
	 * If set to true the agent exposes functionality via JMX.
	 */
	@Parameter(property = "bjacoco.jmx")
	Boolean jmx;
