...
import org.bjacoco.report.check.Limit;
...
public class CheckMojo extends AbstractJacocoMojo implements IViolationsOutput {
	 ...
	 */
	@Parameter(property = "bjacoco.haltOnFailure", defaultValue = "true", required = true)
	private boolean haltOnFailure;

	/**
	 * File with execution data.
	 */
	@Parameter(defaultValue = "${project.build.directory}/bjacoco.exec")
