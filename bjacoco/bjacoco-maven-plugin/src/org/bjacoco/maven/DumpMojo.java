...
import org.bjacoco.core.tools.ExecDumpClient;
...
public class DumpMojo extends AbstractJacocoMojo {
	 ...
	 */
	@Parameter(property = "bjacoco.destFile", defaultValue = "${project.build.directory}/bjacoco.exec")
	 ...
	 */
	@Parameter(property = "bjacoco.append", defaultValue = "true")
	private boolean append;

	/**
	 * Sets whether execution data should be downloaded from the remote host.
	 */
	@Parameter(property = "bjacoco.dump", defaultValue = "true")
	 ...
	 * been dumped.
	 */
	@Parameter(property = "bjacoco.reset", defaultValue = "false")
	 ...
	 */
	@Parameter(property = "bjacoco.port", defaultValue = "6300")
	private int port;
	 ...
	 */
	@Parameter(property = "bjacoco.retryCount", defaultValue = "10")
