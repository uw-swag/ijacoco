...
import org.bjacoco.core.analysis.Analyzer;
import org.bjacoco.core.analysis.CoverageBuilder;
import org.bjacoco.core.analysis.IBundleCoverage;
import org.bjacoco.core.analysis.IClassCoverage;
import org.bjacoco.core.tools.ExecFileLoader;
import org.bjacoco.report.FileMultiReportOutput;
...
import org.bjacoco.report.MultiReportVisitor;
import org.bjacoco.report.check.IViolationsOutput;
import org.bjacoco.report.check.Rule;
import org.bjacoco.report.check.RulesChecker;
import org.bjacoco.report.csv.CSVFormatter;
import org.bjacoco.report.html.HTMLFormatter;
import org.bjacoco.report.xml.XMLFormatter;
...
final class ReportSupport {
	...
	public void addAllFormatters(final File targetdir, final String encoding,
			final String footer, final Locale locale) throws IOException {
		targetdir.mkdirs();
		addXmlFormatter(new File(targetdir, "bjacoco.xml"), encoding);
		addCsvFormatter(new File(targetdir, "bjacoco.csv"), encoding);
