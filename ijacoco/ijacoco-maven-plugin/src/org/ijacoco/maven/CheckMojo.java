...
import org.ijacoco.report.check.Limit;
...
public class CheckMojo extends AbstractJacocoMojo implements IViolationsOutput {
	...
	private static final String MSG_SKIPPING = "Skipping iJaCoCo execution due to missing execution data file:";
	 ...
	 */
	@Parameter(property = "ijacoco.haltOnFailure", defaultValue = "true", required = true)
	private boolean haltOnFailure;

	/**
	 * File with execution data.
	 */
	@Parameter(defaultValue = "${project.build.directory}/ijacoco.exec")
