...
import org.ijacoco.core.coverage.tools.ExecDumpClient;
import org.ijacoco.core.coverage.tools.ExecFileLoader;

/**
 * <p>
 * Request a dump over TCP/IP from a iJaCoCo agent running in
...
public class DumpMojo extends AbstractJacocoMojo {
	 ...
	 */
	@Parameter(property = "ijacoco.destFile", defaultValue = "${project.build.directory}/ijacoco.exec")
	 ...
	 */
	@Parameter(property = "ijacoco.append", defaultValue = "true")
	private boolean append;

	/**
	 * Sets whether execution data should be downloaded from the remote host.
	 */
	@Parameter(property = "ijacoco.dump", defaultValue = "true")
	 ...
	 * been dumped.
	 */
	@Parameter(property = "ijacoco.reset", defaultValue = "false")
	...
	/**
	 * Port number to connect to. If multiple iJaCoCo agents should run on the
	 * same machine, different ports have to be specified for the agents.
	 */
	@Parameter(property = "ijacoco.port", defaultValue = "6300")
	private int port;
	 ...
	 */
	@Parameter(property = "ijacoco.retryCount", defaultValue = "10")
