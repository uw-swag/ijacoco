...
/**
 * The ultimate goal for this Mojo is to predict execution time. At the moment
 * this Mojo only prints classes that are not being affected without any other
 * calculation.
 */
@Mojo(name = "predict", defaultPhase = LifecyclePhase.INITIALIZE)
public class PredictRTSMojo extends StaticSelectRTSMojo {
