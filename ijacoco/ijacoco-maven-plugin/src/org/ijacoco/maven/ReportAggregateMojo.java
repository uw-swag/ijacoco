 ...
 * depends on. From those projects class and source files as well as iJaCoCo
...
public class ReportAggregateMojo extends AbstractReportMojo {
	 ...
	 * used instead.
	 */
	@Parameter(defaultValue = "${project.reporting.outputDirectory}/ijacoco-aggregate")
	...
	public void setReportOutputDirectory(final File reportOutputDirectory) {
		if (reportOutputDirectory != null && !reportOutputDirectory
				.getAbsolutePath().endsWith("ijacoco-aggregate")) {
	...
	public String getOutputName() {
		return "ijacoco-aggregate/index";
	}

	public String getName(final Locale locale) {
		return "iJaCoCo Aggregate";
	}
