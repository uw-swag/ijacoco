...
public class ReportITMojo extends AbstractReportMojo {
	 ...
	 * used instead.
	 */
	@Parameter(defaultValue = "${project.reporting.outputDirectory}/ijacoco-it")
	private File outputDirectory;

	/**
	 * File with execution data.
	 */
	@Parameter(defaultValue = "${project.build.directory}/ijacoco-it.exec")
	...
	public void setReportOutputDirectory(final File reportOutputDirectory) {
		if (reportOutputDirectory != null && !reportOutputDirectory
				.getAbsolutePath().endsWith("ijacoco-it")) {
			outputDirectory = new File(reportOutputDirectory, "ijacoco-it");
		} else {
