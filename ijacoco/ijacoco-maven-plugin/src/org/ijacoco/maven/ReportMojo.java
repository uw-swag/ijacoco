...
public class ReportMojo extends AbstractReportMojo {
	 ...
	 * used instead.
	 */
	@Parameter(defaultValue = "${project.reporting.outputDirectory}/ijacoco")
	private File outputDirectory;

	/**
	 * File with execution data.
	 */
	@Parameter(property = "ijacoco.dataFile", defaultValue = "${project.build.directory}/ijacoco.exec")
	...
	public void setReportOutputDirectory(final File reportOutputDirectory) {
		if (reportOutputDirectory != null && !reportOutputDirectory
				.getAbsolutePath().endsWith("ijacoco")) {
			outputDirectory = new File(reportOutputDirectory, "ijacoco");
		} else {
