 ...
 * written are in iJaCoCo execution data format.
 *
 * @deprecated Use {@link org.ijacoco.agent.rt.IAgent} instead.
 */
@Deprecated
public final class RT {
	...
	/**
	 * Writes the current execution data to the given file in iJaCoCo execution
	 * data format.
	 *
	 * @param outFile
	...
	public static void dumpCoverageData(final File outFile, final boolean merge,
		...
		try {
			out.write(
					org.ijacoco.agent.rt.RT.getAgent().getExecutionData(false));
		} finally {
			out.close();
		}
	}
