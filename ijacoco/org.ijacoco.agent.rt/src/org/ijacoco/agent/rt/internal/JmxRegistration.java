...
/**
 * Access to JMX APIs are encapsulated in this class to allow the iJaCoCo
 * runtime on platforms without JMX support (e.g Android).
 */
class JmxRegistration implements Callable<Void> {

	private static final String JMX_NAME = "org.ijacoco:type=Runtime";
