 ...
 * is provided through system properties prefixed with <code>ijacoco.</code>.
 */
public final class Offline {

	private static final String CONFIG_RESOURCE = "/ijacoco-agent.properties";
	...
	private static synchronized RuntimeData getRuntimeData() {
		if (data == null) {
			...
			try {
				...
				throw new RuntimeException("Failed to initialize iJaCoCo.", e);
			}
		}
		return data;
	}
