...
public final class AgentJar {
	 ...
	 */
	private static final String RESOURCE = "/ijacocoagent.jar";
	...
	/**
	 * Extract the iJaCoCo agent JAR and put it into a temporary location. This
	...
	public static File extractToTempLocation() throws IOException {
		final File agentJar = File.createTempFile("ijacocoagent", ".jar");
	...
	/**
	 * Extract the iJaCoCo agent JAR and put it into the specified location.
	 *
	 * @param destination
	 *            Location to write iJaCoCo Agent Jar to. Must be writeable
	 * @throws IOException
	 *             Unable to unpack agent jar
	 */
	...
	private static final String ERRORMSG = String
			.format("The resource %s has not been found. Please see "
					+ "/org.ijacoco.agent/README.TXT for details.", RESOURCE);
