 ...
 *
 *******************************************************************************/
package org.ijacoco.core.coverage.runtime;
...
public final class AgentOptions {
	 ...
	 * <code>ijacoco.exec</code> in the working directory.
	 */
	 ...
	 */
	public static final String DEFAULT_DESTFILE = "ijacoco.exec";
	...
	/**
	 * Specifies whether the agent will automatically merge coverage data on VM
	 * exit. Default is <code>true</code>.
	 */
	public static final String MERGEONEXIT = "mergeonexit";
	 ...
	 * iJaCoCo agents should run on the same machine, different ports have to be
	 ...
	 * name "org.ijacoco:type=Runtime". Default is <code>false</code>.
	 */
	public static final String JMX = "jmx";

	private static final Collection<String> VALID_OPTIONS = Arrays.asList(
			DESTFILE, APPEND, INCLUDES, EXCLUDES, EXCLCLASSLOADER,
			INCLBOOTSTRAPCLASSES, INCLNOLOCATIONCLASSES, SESSIONID, MERGEONEXIT,
	...
	/**
	 * Returns whether coverage data should be merged on exit.
	 *
	 * @return <code>true</code> if coverage data will be merged on VM exit
	 */
	public boolean getMergeOnExit() {
		return getOption(MERGEONEXIT, false);
	}

	/**
	 * Sets whether coverage data should be merged on exit.
	 *
	 * @param mergeOnExit
	 *            <code>true</code> if coverage data should be merged on VM exit
	 */
	public void setMergeOnExit(final boolean mergeOnExit) {
		setOption(MERGEONEXIT, mergeOnExit);
	}
	 ...
	 *
	 * @param agentJarFile
	 *            location of the iJaCoCo Agent Jar
	 ...
	 * @param agentJarFile
	 *            location of the iJaCoCo Agent Jar
	 * @return VM command line arguments prepended with configured iJaCoCo agent
	 */
