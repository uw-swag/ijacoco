...
public final class Instr {
	...
	public static final String LOADER_MONITOR_CLASS_INTERNAL_NAME = Names.RTS_PACKAGE_VM
			+ "/monitor/LoaderMonitor";
	public static final String REFLECTION_MONITOR_CLASS_INTERNAL_NAME = Names.RTS_PACKAGE_VM
			+ "/monitor/ReflectionMonitor";
	public static final String FILE_MONITOR_CLASS_INTERNAL_NAME = Names.RTS_PACKAGE_VM
			+ "/monitor/FileMonitor";
	public static final String SYSTEM_MONITOR_CLASS_INTERNAL_NAME = Names.RTS_PACKAGE_VM
