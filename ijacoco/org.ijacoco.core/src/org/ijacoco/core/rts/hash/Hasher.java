...
public class Hasher {
	 ...
	 * Constructor.
	 */
	public Hasher(Algorithm algorithm, int cacheSizes,
			boolean isSemanticHashing) {
	...
	public synchronized Map<String, String> hashExternalForms(
			String[] externalForms) {
		Map<String, String> hashes = new HashMap<String, String>();
	...
	public String hashByteCode(byte[] bytes) {
		if (bytes == null)
			return ERR_HASH;
