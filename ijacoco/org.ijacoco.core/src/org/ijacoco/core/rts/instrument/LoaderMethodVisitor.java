...
import org.ijacoco.core.rts.monitor.LoaderMonitor;
 ...
 * instrumented code invokes appropriate monitor to return classes that are
 * known to SystemClassLoader. This code is needed as we want to avoid loading
 * classes with multiple class loaders in the same VM. The need for this class
 * was shown during runs of tests in Apache ant, e.g.,
 ...
 * being loaded is from RTS package. If that is the case, we forward method
...
public class LoaderMethodVisitor extends MethodVisitor {
	...
	public void visitCode() {
		...
		mv.visitLdcInsn(Names.RTS_PACKAGE_BIN);
		mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL,
				Instr.STRING_CLASS_INTERNAL_NAME, Instr.STARTS_WITH_MNAME,
		...
		mv.visitMethodInsn(Opcodes.INVOKESTATIC,
				Instr.LOADER_MONITOR_CLASS_INTERNAL_NAME,
