...
public class SystemMethodVisitor extends MethodVisitor {
	...
	public void visitMethodInsn(int opcode, String owner, String name,
		...
		if (opcode == Opcodes.INVOKESTATIC
				&& owner.equals(Instr.SYSTEM_CLASS_INTERNAL_NAME)
				&& name.equals(Instr.RUN_FINALIZATION_MNAME)
				&& desc.equals(Instr.RUN_FINALIZATION_MDESC) && !itf) {
			mv.visitMethodInsn(Opcodes.INVOKESTATIC,
					Instr.SYSTEM_MONITOR_CLASS_INTERNAL_NAME, name, desc,
					false);
		} else if (opcode == Opcodes.INVOKESTATIC
				&& owner.equals(Instr.SYSTEM_CLASS_INTERNAL_NAME)
				&& name.equals(Instr.GC_MNAME) && desc.equals(Instr.GC_MDESC)
				&& !itf) {
			mv.visitMethodInsn(Opcodes.INVOKESTATIC,
					Instr.SYSTEM_MONITOR_CLASS_INTERNAL_NAME, name, desc,
					false);
