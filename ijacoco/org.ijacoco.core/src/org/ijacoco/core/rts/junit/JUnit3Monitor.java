...
public class JUnit3Monitor {
	 ...
	 */
	public static boolean addTestsFromTestCase(final TestSuite testSuite,
			final Class<?> testClass) {
		if (isOnStack(0, "org.junit.internal.builders.")
				|| isOnStack(0, JUnit3TestSuite.class.getCanonicalName())) {
			return true;
		} else {
