...
public class JUnitCFT implements ClassFileTransformer {
	...
	public static class TestSuiteMethodVisitor extends MethodVisitor {
		...
		public void visitFieldInsn(int opcode, String owner, String name,
			...
			if (opcode == Opcodes.PUTFIELD
				...
				mv.visitMethodInsn(Opcodes.INVOKESTATIC,
						JUnitNames.JUNIT3_MONITOR_VM, "addTestsFromTestCase",
						"(Ljunit/framework/TestSuite;Ljava/lang/Class;)Z",
						false);
	...
	public byte[] transform(ClassLoader loader, String className,
		...
		if (className.startsWith("org/apache/tools/ant")
			...
			JUnitClassVisitor visitor = new JUnitClassVisitor(className,
					classWriter);
			...
			ClassWriter classWriter = new ClassWriter(classReader,
					ClassWriter.COMPUTE_FRAMES | ClassWriter.COMPUTE_MAXS);
			TestSuiteClassVisitor visitor = new TestSuiteClassVisitor(
					classWriter);
			classReader.accept(visitor, 0);
			return classWriter.toByteArray();
		}
