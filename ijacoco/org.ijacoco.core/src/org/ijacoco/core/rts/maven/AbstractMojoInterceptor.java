...
package org.ijacoco.core.rts.maven;
...
public abstract class AbstractMojoInterceptor {
	...
	public static final String ARGLINE_INTERNAL_PROP = "ijacoco.argline.internal";
	/** Property key used to pass excludes list from plugin to interceptor */
	public static final String EXCLUDES_INTERNAL_PROP = "ijacoco.excludes.internal";
	...
	protected static String makeArgLine(Object mojo, Config.AgentMode junitMode,
			String currentArgLine) throws Exception {
		...
		// Get argLine as prepared by RTS plugin.
		String rtsArgLine = System.getProperty(ARGLINE_INTERNAL_PROP);
		String newArgLine = currentArgLine == null || currentArgLine.equals("")
				? rtsArgLine
				: rtsArgLine + " " + currentArgLine;
	 ...
	 */
	protected static void throwMojoExecutionException(Object mojo,
			String message, Exception cause) throws Exception {
		Class<?> clz = mojo.getClass().getClassLoader()
				.loadClass(MavenNames.MOJO_EXECUTION_EXCEPTION_BIN);
	 ...
	 * name.
	 */
	protected static String invokeAndGetString(String methodName, Object mojo)
			throws Exception {
	 ...
	 */
	protected static boolean invokeAndGetBoolean(String methodName, Object mojo)
			throws Exception {
	...
	protected static List<String> invokeAndGetList(String methodName,
			Object mojo) throws Exception {
		return (List<String>) invokeGetMethod(methodName, mojo);
	}

	protected static void invokeSetMethod(String methodName, Object mojo,
	...
	private static Object invokeGetMethod(String methodName, Object mojo)
			throws Exception {
	 ...
	 */
	protected static void setField(String fieldName, Object mojo, Object value)
			throws Exception {
		Field field = null;
		try {
	 ...
	 */
	protected static Object getField(String fieldName, Object mojo)
			throws Exception {
		Field field = null;
		try {
			field = mojo.getClass().getDeclaredField(fieldName);
	...
	@SuppressWarnings("unchecked")
	protected static List<String> getListField(String fieldName, Object mojo)
			throws Exception {
		return (List<String>) getField(fieldName, mojo);
	}

	protected static String getStringField(String fieldName, Object mojo)
			throws Exception {
	...
	protected static void warn(Object mojo, String msg) throws Exception {
		...
		method = logObject.getClass().getMethod(WARN_METHOD,
				CharSequence.class);
		method.setAccessible(true);
